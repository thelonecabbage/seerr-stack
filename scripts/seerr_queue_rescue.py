...
APPS = {
    "sonarr": {
        "port": 8989,
        "config": Path("/opt/media/config/sonarr/config.xml"),
    ...
    "radarr": {
        "port": 7878,
        "config": Path("/opt/media/config/radarr/config.xml"),
...
def qbit_api_key() -> str:
    config = Path("/opt/media/config/qbittorrent/qBittorrent/qBittorrent.conf")
